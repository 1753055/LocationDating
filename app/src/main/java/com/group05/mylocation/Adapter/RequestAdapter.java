...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.connection_request_items, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_ask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Map tmp = new HashMap<>();
                tmp.put("accepted", true);
                Map tmp2 = new HashMap<>();
                tmp.put("isAccepted", true);

                db.collection("User").document(mUsers.get(position).getUid()).collection("connection").document(FirebaseAuth.getInstance().getUid()).set(tmp2, SetOptions.merge());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btn_ask = itemView.findViewById(R.id.btnAccept);
